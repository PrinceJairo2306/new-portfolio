    ...
    <>
      ...
      >
        <div>
          ...
          >
            <div className={`opacity-60 font-normal hover:font-medium hover:animate-pulse hover:opacity-60 ${isMenuOpen ? "about" : ""}`}>
              <span className="">{ismenuFinishedOpenning ? "about" : ""}</span>
            </div>
            <div className={` opacity-60 font-normal hover:font-medium hover:animate-pulse hover:opacity-60 ${isMenuOpen ? "projects" : ""}`}>
              <span>{ismenuFinishedOpenning ? "projects" : ""}</span>
            </div>
            <div className={`opacity-60 font-normal hover:font-medium hover:animate-pulse hover:opacity-60 ${isMenuOpen ? "experience" : ""}`}>
              <span>{ismenuFinishedOpenning ? "experience" : ""}</span>
            </div>
            <div className={`opacity-60 font-normal hover:font-medium hover:animate-pulse hover:opacity-60 ${isMenuOpen ? "contact" : ""}`}>
              <span>{ismenuFinishedOpenning ? "contact" : ""}</span>
            </div>
            <div className={`pb-1 opacity-60 font-normal hover:font-medium hover:animate-pulse hover:opacity-60 ${isMenuOpen ? "blogs" : ""}`}>
